...
class Settings:
    ...
    CORS_ORIGINS: List[str] = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://127.0.0.1:3000,https://good-vibes-planner.vercel.app,https://your-actual-vercel-url.vercel.app").split(",")
